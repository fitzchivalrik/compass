...
namespace SimpleTweaksPlugin.Helper {
    public static unsafe partial class UiHelper {
        ...
        //TODO ADDITIONS
        public static void SetPosition(AtkImageNode* node, float? x, float? y) => SetPosition((AtkResNode*)node, x, y);
        public static AtkImageNode* CloneNode(AtkImageNode* node) => (AtkImageNode*) CloneNode((AtkResNode*) node);
        public static void SetSize(AtkImageNode* node, int? w, int? h) => SetSize((AtkResNode*)node, w, h);
        //TODO END ADDTIONS
    }
}
#endif
