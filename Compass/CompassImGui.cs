...
{
    private DrawData _drawData =  new() 
    {
        PlayerPosition = new Vector2(DrawData.NaviMapPlayerX, DrawData.NaviMapPlayerY),
        ...
        BackgroundColourUInt32 = DrawData.WhiteColor,
        BackgroundBorderColourUInt32 = DrawData.WhiteColor,
        BackgroundLineColourUInt32 = DrawData.WhiteColor,
        DistanceToTargetColourUInt32 = DrawData.WhiteColor,
        CurrentScaleOffset =  DrawData.NaviMapScaleOffset,
    };
    ...
    private bool UpdateCompassVariables()
    {
        ...
        _drawData.Scale = _config.ImGuiCompassScale * ImGui.GetIO().FontGlobalScale;
        _drawData.HeightScale = ImGui.GetIO().FontGlobalScale;

        _drawData.DistanceScaleFactorForRotationIcons = _drawData.Scale * 0.7f;
        _drawData.RotationIconHalfWidth = 16f * _drawData.DistanceScaleFactorForRotationIcons;

        _drawData.HalfWidth = _config.ImGuiCompassWidth * 0.5f;
        _drawData.HalfHeight = DrawData.Height * 0.5f * _drawData.HeightScale;

        _drawData.CompassUnit = _config.ImGuiCompassWidth / (2f*(float)Math.PI);
        _drawData.Centre =
            new Vector2(_config.ImGuiCompassPosition.X + _drawData.HalfWidth,
                _config.ImGuiCompassPosition.Y + _drawData.HalfHeight);

        _drawData.BackgroundPMin = new Vector2(
            _drawData.Centre.X - 5 - _drawData.HalfWidth * _config.ImGuiCompassReverseMaskPercentage
            , _drawData.Centre.Y - _drawData.HalfHeight * 0.5f - 2
        );
        _drawData.BackgroundPMax = new Vector2(
            _drawData.Centre.X + 5 + _drawData.HalfWidth * _config.ImGuiCompassReverseMaskPercentage
            , _drawData.Centre.Y + _drawData.HalfHeight * 0.5f + 2
        );
        _drawData.BackgroundLinePMin = new Vector2(
            _drawData.BackgroundPMin.X
            , _config.ImGuiCompassBackgroundLineOffset + _drawData.BackgroundPMin.Y + _drawData.HalfHeight
        );
        _drawData.BackgroundLinePMax = new Vector2(
            _drawData.BackgroundPMax.X,
            _config.ImGuiCompassBackgroundLineOffset + _drawData.BackgroundPMin.Y + _drawData.HalfHeight
        );
        _drawData.DistanceToTargetPMin = _drawData.Centre + _config.ImGuiCompassDistanceToTargetOffset;
        _drawData.DistanceToTargetScale =
            ImGui.GetIO().FontGlobalScale * _config.ImGuiCompassDistanceToTargetScale;
        _drawData.DrawListPMin =
            _drawData.BackgroundPMin + new Vector2(-2, -100);
        _drawData.DrawListPMax = 
            _drawData.BackgroundPMax + new Vector2(2, 100);
        _drawData.BackgroundDrawListPMin =
            _drawData.BackgroundPMin + new Vector2(-3, -100);
        _drawData.BackgroundDrawListPMax =
            _drawData.BackgroundPMax + new Vector2(3, 100);

        _drawData.WeatherIconPMin =
            _drawData.BackgroundPMin + _config.ImGuiCompassWeatherIconOffset + new Vector2(2, 1) * _config.ImGuiCompassWeatherIconScale;
        _drawData.WeatherIconPMax = 
            _drawData.WeatherIconPMin + new Vector2(32, 32) * _config.ImGuiCompassWeatherIconScale;
            
        _drawData.WeatherIconBorderPMin = _config.ShowWeatherIconBorder
            ? _drawData.BackgroundPMin + _config.ImGuiCompassWeatherIconOffset 
            : Vector2.Zero;
        _drawData.WeatherIconBorderPMax = _config.ShowWeatherIconBorder
            ? _drawData.WeatherIconBorderPMin + new Vector2(36, 36)* _config.ImGuiCompassWeatherIconScale
            : Vector2.Zero;
                            
        _drawData.HalfWidth40 = 20 * _drawData.Scale;
        _drawData.HalfWidth28 = 14 * _drawData.Scale;

        _drawData.BackgroundColourUInt32 = ImGui.ColorConvertFloat4ToU32(_config.ImGuiBackgroundColour);
        _drawData.BackgroundBorderColourUInt32 = ImGui.ColorConvertFloat4ToU32(_config.ImGuiBackgroundBorderColour);
        _drawData.BackgroundLineColourUInt32 = ImGui.ColorConvertFloat4ToU32(_config.ImGuiBackgroundLineColour);
        _drawData.DistanceToTargetColourUInt32 = ImGui.ColorConvertFloat4ToU32(_config.ImGuiCompassDistanceToTargetColour);

        _drawData.MinScaleFactor = _config.UseAreaMapAsSource ? _config.ImGuiCompassMinimumIconScaleFactorAreaMap : _config.ImGuiCompassMinimumIconScaleFactor;
        _drawData.MaxDistance = _config.UseAreaMapAsSource ? _config.AreaMapMaxDistance : 180f;
        _drawData.CurrentScaleOffset = _config.UseAreaMapAsSource
            ? DrawData.AreaMapScaleOffset
            : DrawData.NaviMapScaleOffset;
    ...
    private void DrawDistanceToTarget()
    {
        ...
        var distanceToTargetScale = font.FontSize * _drawData.DistanceToTargetScale;
        drawList.AddText(font,
            distanceToTargetScale,
            _drawData.DistanceToTargetPMin + new Vector2(-1,+1)
            , 0xFF000000,
            text);
        drawList.AddText(font,
            distanceToTargetScale,
            _drawData.DistanceToTargetPMin + new Vector2(0,+1)
            , 0xFF000000
            , text);
        drawList.AddText(font,
            distanceToTargetScale,
        ...
        drawList.AddText(font,
            distanceToTargetScale,
            _drawData.DistanceToTargetPMin + new Vector2(-1,0)
            , 0xFF000000,
            text);
        drawList.AddText(font,
            distanceToTargetScale,
        ...
        drawList.AddText(font,
            distanceToTargetScale,
            _drawData.DistanceToTargetPMin
            , _drawData.DistanceToTargetColourUInt32,
            text);
    ...
    private void DrawWeatherIcon()
    {
        ...
        try
        {
            ...
            backgroundDrawList.AddImage(
                ...
                , _drawData.WeatherIconBorderPMin
                , _drawData.WeatherIconBorderPMax
            ...
            backgroundDrawList.AddImage(
                new IntPtr(tex->D3D11ShaderResourceView), _drawData.WeatherIconPMin,
                _drawData.WeatherIconPMax);
    ...
    private void DrawCompassIcons(Vector2 playerForward)
    {
        try
        {
            ...
            var mapScale = *(float*) ((long) _currentSourceBase + _drawData.CurrentScaleOffset);
            var distanceOffset = 20f * mapScale;  
            var maxDistance = _drawData.MaxDistance * mapScale;
...
//                        PluginLog.Debug($"TextureIdPtr is null? {textureIdPtr == IntPtr.Zero}");
                    ...
                    var uv = Vector2.Zero;
                    var uv1 = Vector2.One;
                    var tintColour = DrawData.WhiteColor;
                    var rotate = false;
                    switch (iconId)
                    {
                        ...
                        case 0: //Arrows to quests and fates
                            ...
                            var naviMapCutIconOffset = _drawData.CompassUnit *
                                                       SignedAngle(mapIconComponentNode->AtkResNode.Rotation,
                                                           playerForward);
                            // We hope width == height
                            const int naviMapIconHalfWidth = 12;
                            var naviMapYOffset = 14 * _drawData.Scale;
                            pMin = new Vector2(_drawData.Centre.X - naviMapIconHalfWidth + naviMapCutIconOffset, _drawData.Centre.Y - naviMapYOffset - naviMapIconHalfWidth);
                            pMax = new Vector2(_drawData.Centre.X + naviMapCutIconOffset + naviMapIconHalfWidth, _drawData.Centre.Y - naviMapYOffset + naviMapIconHalfWidth);
                            break;
                        case 1: // Rotation icons (except naviMap arrows) go here after setting up their UVs
                            ...
                            var rotationIconOffset = _drawData.CompassUnit *
                                                     SignedAngle(mapIconComponentNode->AtkResNode.Rotation,
                                                         playerForward);
                            pMin = new Vector2(_drawData.Centre.X - _drawData.RotationIconHalfWidth + rotationIconOffset, _drawData.Centre.Y - _drawData.RotationIconHalfWidth);
                            pMax = new Vector2(_drawData.Centre.X + rotationIconOffset + _drawData.RotationIconHalfWidth, _drawData.Centre.Y + _drawData.RotationIconHalfWidth);
                            break;
                        case 060443: //Player Marker
                            if (!_config.ImGuiCompassEnableCenterMarker) continue;
                            drawList = ImGui.GetBackgroundDrawList();
                            pMin = new Vector2(_drawData.Centre.X - _drawData.HalfWidth40, _drawData.Centre.Y + _config.ImGuiCompassCentreMarkerOffset * _drawData.Scale - _drawData.HalfWidth40);
                            pMax = new Vector2(_drawData.Centre.X + _drawData.HalfWidth40, _drawData.Centre.Y + _config.ImGuiCompassCentreMarkerOffset * _drawData.Scale + _drawData.HalfWidth40);
                            uv1 = _config.ImGuiCompassFlipCentreMarker ? new Vector2(1, -1) : Vector2.One;
                            _drawData.PlayerPosition = new Vector2(mapIconComponentNode->AtkResNode.X, -mapIconComponentNode->AtkResNode.Y);
                            break;
                        //case  >5 and <9 :
                        //    break;
                        ...
                        case 060498: // One More Circle
                            ...
                            (pMin, pMax, tintColour, inArea)
                                = CalculateAreaCirlceVariables(_drawData.PlayerPosition, playerForward, mapIconComponentNode,
                                    imgNode, distanceOffset, _drawData.CompassUnit, _drawData.HalfWidth40, _drawData.Centre,
                                    maxDistance, _drawData.MinScaleFactor);
                            if (inArea)
                                //*((byte*) &tintColour + 3) = 0x33  == (0x33FFFFFF) & (tintColour)
                                ImGui.GetBackgroundDrawList().AddRectFilled(_drawData.BackgroundPMin
                                    , _drawData.BackgroundPMax
                        ...
                        default:
                            ...
                            var (distanceScaleFactor, iconAngle, _) = CalculateDrawVariables(_drawData.PlayerPosition,
                                new Vector2(
                                ...
                                distanceOffset,
                                maxDistance,
                                _drawData.MinScaleFactor
                            );
                            var iconOffset = _drawData.CompassUnit * iconAngle;
                            var iconHalfWidth = _drawData.HalfWidth40 * distanceScaleFactor;
                            pMin = new Vector2(_drawData.Centre.X - iconHalfWidth + iconOffset, _drawData.Centre.Y - iconHalfWidth);
                            pMax = new Vector2(_drawData.Centre.X + iconOffset + iconHalfWidth, _drawData.Centre.Y + iconHalfWidth);
                            break;
                    }
    ...
    private void DrawCardinals(Vector2 playerForward)
    {
        ...
        var pMinY = _drawData.Centre.Y - _drawData.HalfWidth40 + _config.ImGuiCompassCardinalsOffset;
        var pMaxY = _drawData.Centre.Y + _drawData.HalfWidth40 + _config.ImGuiCompassCardinalsOffset;
        var eastOffset = _drawData.CompassUnit * SignedAngle(east, playerForward);
        backgroundDrawList.AddImage( //East
            _naviMapTextureD3D11ShaderResourceView
            , new Vector2(_drawData.Centre.X - _drawData.HalfWidth28 + eastOffset, pMinY)
            , new Vector2(_drawData.Centre.X + eastOffset + _drawData.HalfWidth28, pMaxY)
            , new Vector2(0.5446429f, 0.8301887f)
            , new Vector2(0.5892857f, 0.9811321f)
        );
        var southOffset = _drawData.CompassUnit * SignedAngle(south, playerForward);
        backgroundDrawList.AddImage( // South
            _naviMapTextureD3D11ShaderResourceView
            , new Vector2(_drawData.Centre.X - _drawData.HalfWidth28 + southOffset, pMinY)
            , new Vector2(_drawData.Centre.X + southOffset + _drawData.HalfWidth28, pMaxY)
            , new Vector2(0.5892857f, 0.8301887f)
            , new Vector2(0.6339286f, 0.9811321f)
        );
        var westOffset = _drawData.CompassUnit * SignedAngle(west, playerForward);
        backgroundDrawList.AddImage( //West
            _naviMapTextureD3D11ShaderResourceView
            , new Vector2(_drawData.Centre.X - _drawData.HalfWidth40 + westOffset, pMinY)
            , new Vector2(_drawData.Centre.X + westOffset + _drawData.HalfWidth40, pMaxY)
            , new Vector2(0.4732143f, 0.8301887f)
            , new Vector2(0.5446429f, 0.9811321f)
        );
        var northOffset = _drawData.CompassUnit * SignedAngle(north, playerForward);
        backgroundDrawList.AddImage( // North
            _naviMapTextureD3D11ShaderResourceView
            , new Vector2(_drawData.Centre.X - _drawData.HalfWidth40 + northOffset, pMinY)
            , new Vector2(_drawData.Centre.X + northOffset + _drawData.HalfWidth40, pMaxY)
    ...
    private void DrawInterCardinals(Vector2 playerForward)
    {
        ...
        var pMinY = _drawData.Centre.Y - 15f + _config.ImGuiCompassCardinalsOffset;
        var pMaxY = _drawData.Centre.Y + 15f + _config.ImGuiCompassCardinalsOffset;
        var northeastOffset = _drawData.CompassUnit * SignedAngle(northeast, playerForward);
        backgroundDrawList.AddImage( // North
            _naviMapTextureD3D11ShaderResourceView
            , new Vector2(_drawData.Centre.X - _drawData.HalfWidth28 + northeastOffset - 7f, pMinY)
            , new Vector2(_drawData.Centre.X + northeastOffset + _drawData.HalfWidth28 - 7f, pMaxY)
            , new Vector2(0.4017857f, 0.8301887f)
            , new Vector2(0.4732143f, 0.9811321f)
        );
        backgroundDrawList.AddImage( // East
        ...
        var southeastOffset = _drawData.CompassUnit * SignedAngle(southeast, playerForward);
        backgroundDrawList.AddImage(//South
            _naviMapTextureD3D11ShaderResourceView
            , new Vector2(_drawData.Centre.X - _drawData.HalfWidth28 + southeastOffset - 7f, pMinY)
            , new Vector2(_drawData.Centre.X + southeastOffset + _drawData.HalfWidth28 - 7f, pMaxY)
            , new Vector2(0.5892857f, 0.8301887f)
            , new Vector2(0.6339286f, 0.9811321f)
        );
        backgroundDrawList.AddImage( // East
        ...
        var southwestOffset = _drawData.CompassUnit * SignedAngle(southwest, playerForward);
        backgroundDrawList.AddImage(//South
            _naviMapTextureD3D11ShaderResourceView
            , new Vector2(_drawData.Centre.X - _drawData.HalfWidth28 + southwestOffset - 7f, pMinY)
            , new Vector2(_drawData.Centre.X + southwestOffset + _drawData.HalfWidth28 - 7f, pMaxY)
            , new Vector2(0.5892857f, 0.8301887f)
            , new Vector2(0.6339286f, 0.9811321f)
        );
        backgroundDrawList.AddImage( // West
        ...
        var northwestOffset = _drawData.CompassUnit * SignedAngle(northwest, playerForward);
        backgroundDrawList.AddImage( // North
            _naviMapTextureD3D11ShaderResourceView
            , new Vector2(_drawData.Centre.X - _drawData.HalfWidth28 + northwestOffset - 7f, pMinY)
            , new Vector2(_drawData.Centre.X + northwestOffset + _drawData.HalfWidth28 - 7f, pMaxY)
            , new Vector2(0.4017857f, 0.8301887f)
            , new Vector2(0.4732143f, 0.9811321f)
        );
        backgroundDrawList.AddImage( // West
    ...
    private void DrawImGuiCompassBackground()
    {
        ...
        if (_config.ImGuiCompassBackground is ImGuiCompassBackgroundStyle.Filled or ImGuiCompassBackgroundStyle.FilledAndBorder)
            backgroundDrawList.AddRectFilled(_drawData.BackgroundPMin
                , _drawData.BackgroundPMax
                , _drawData.BackgroundColourUInt32
                , _config.ImGuiCompassBackgroundRounding
            );
        if (_config.ImGuiCompassBackground is ImGuiCompassBackgroundStyle.Border or ImGuiCompassBackgroundStyle.FilledAndBorder)
            backgroundDrawList.AddRect(_drawData.BackgroundPMin - Vector2.One
                , _drawData.BackgroundPMax + Vector2.One
                , _drawData.BackgroundBorderColourUInt32
                , _config.ImGuiCompassBackgroundRounding
                , ImDrawFlags.RoundCornersAll
                , _config.ImGuiBackgroundBorderThickness
            );
        if (_config.ImGuiCompassBackground is ImGuiCompassBackgroundStyle.Line)
            backgroundDrawList.AddLine(_drawData.BackgroundLinePMin
                , _drawData.BackgroundLinePMax
                , _drawData.BackgroundLineColourUInt32
    ...
    {
        // NOTE: We loop through max 8 at a time because else it tanks performance to much,
